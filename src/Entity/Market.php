 ...
 * )
 */
class Market implements RegisterEntityInterface, RegisterDateEntityInterface
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
     ...
     * @Groups({"read"})
     * @Assert\NotBlank(
     *     message="Nombre del segmento no debe estár vacio"
     * )
     * @Assert\NotNull(
     *      message = "Nombre del segmento no debe contener valores NULL"
     * )
     * @Assert\Length(
     *      min = 1,
     *      max = 125,
     *      minMessage = "Nombre del segmento debe contener al menos {{ limit }} caractéres de longitud",
     *      maxMessage = "Nombre del segmento no debe contener mas de  {{ limit }} caractéres"
     * )
     */
    private $name;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\User", inversedBy="markets")
