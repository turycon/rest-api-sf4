 ...
 *      fields={"name"},
 *      errorPath="name",
 *      message="Existe una sede con el mismo nombre"
 * )
 */
class Venue implements RegisterEntityInterface
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
     ...
     * @Groups({"read"})
     * @Assert\NotBlank(
     *     message="Nombre de la sede no debe estár vacio"
     * )
     * @Assert\NotNull(
     *      message = "Nombre de la sede no debe contener valores NULL"
     * )
     * @Assert\Length(
     *      min = 1,
     *      max = 125,
     *      minMessage = "Nombre de la sede debe contener al menos {{ limit }} caractéres de longitud",
     *      maxMessage = "Nombre de la sede no debe contener mas de  {{ limit }} caractéres"
     * )
     */
    private $name;
